...
public final class TileEnergyDiagnostics extends TileBaseNoData implements ITickableTileEntity {
  ...
  public final void tick(){
    ...
    for(final Direction direction : Direction.values()){
      ...
      tile = world.getTileEntity(pos.offset(direction));
      if(tile != null){
        if(tile instanceof BasicEnergyNetworkTile){
          ...
          if(network != null){
            ...
            NetworkUtil.send_to_TileEntity(NetworkHandler.INSTANCE, this, new EnergyDiagnosticsMessage(pos, diagnostics_data, totals));
            return;
          }
        }
      }
    ...
    NetworkUtil.send_to_TileEntity(NetworkHandler.INSTANCE, this, new EnergyDiagnosticsMessage(pos));
  }
