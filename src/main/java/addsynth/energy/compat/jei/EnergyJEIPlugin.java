...
public final class EnergyJEIPlugin implements IModPlugin {
  ...
  private static void add_information(IRecipeRegistration registry){
    ...
    registry.addIngredientInfo(new ItemStack(EnergyBlocks.energy_diagnostics_block), VanillaTypes.ITEM, StringUtil.translate("gui.addsynth_energy.jei_description.energy_diagnostics_block"));
    
    registry.addIngredientInfo(new ItemStack(EnergyItems.power_regulator), VanillaTypes.ITEM, StringUtil.translate("gui.addsynth_energy.jei_description.power_regulator"));
  }
