...
public enum Lens {
  ...
  RED    (1, Names.RED_LENS,     TextFormatting.DARK_RED,     MaterialColor.TNT),
  ORANGE (2, Names.ORANGE_LENS,  TextFormatting.GOLD,         MaterialColor.ADOBE),
  ...
  MAGENTA(7, Names.MAGENTA_LENS, TextFormatting.LIGHT_PURPLE, MaterialColor.MAGENTA);
